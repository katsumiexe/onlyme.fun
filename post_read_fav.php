...
if($tag == "a"){
    $sql ="SELECT reg.reg_name, reg.reg_pic, reg.reg_sex, m1.fav_user_id as my, m1.fav_host_id as you FROM me_fav as m1";
    ...
    $sql ="SELECT reg.reg_name, reg.reg_pic, reg.reg_sex, m1.fav_host_id as my, m1.fav_user_id as you FROM me_fav as m1";
