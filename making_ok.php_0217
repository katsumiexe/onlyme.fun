...
/*
print("name_y□".$name_y."<br>\n");
print("name_h□".$name_h."<br>\n");
print("name_1□".$name_h1."<br>\n");

print("1□".$name_size_tmp[1]."<br>\n");
print("3□".$name_size_tmp[3]."<br>\n");
print("5□".$name_size_tmp[5]."<br>\n");
print("7□".$name_size_tmp[7]."<br>\n");
*/
...
/*
print("orgin_x".$orgin_x."<br>\n");
print("orgin_y".$orgin_y."<br>\n");
print("orgin".$orgin."<br>\n");
*/
