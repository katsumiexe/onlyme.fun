...
<form id="forms" action="./post.php" method="post">
	...
	<?}else{?>
		...
		<div class="box_01">
			<div class="box_02">
				...
				<input type="text" value="<?=$ask_name?>" name="ask_name" placeholder="匿名でもいいよ" style="width:68vw; height:8vw;"><br>
			</div>

			<div class="box_02">
				<span class="title">メールアドレス</span><br>
				<input type="text" value="<?=$ask_mail?>" name="ask_mail" placeholder="なくてもいいよ" style="width:68vw; height:8vw;"><br>
			</div>
